"""Regression checks for the javabus casebook."""
...
from casebook.harness import assert_expected, javabus_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(javabus_summary(), assert_expected())
