...
javabus is a Java project for backend services. It focuses on this technical goal: Implement in-memory broker semantics with consumer groups and ack timeouts.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 151, risk penalty 7, latency penalty 3, and weight bonus 3. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
